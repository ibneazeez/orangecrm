...
/**
 * The persistent class for the ohrm_display_field database table.
 * 
 */
@Entity
@Table(name="ohrm_display_field")
...
public class OhrmDisplayField implements Serializable {
	...
	@OneToMany(mappedBy="ohrmDisplayField")
	...
	public OhrmSelectedDisplayField addOhrmSelectedDisplayField(OhrmSelectedDisplayField ohrmSelectedDisplayField) {
		...
		ohrmSelectedDisplayField.setOhrmDisplayField(this);
	...
	public OhrmSelectedDisplayField removeOhrmSelectedDisplayField(OhrmSelectedDisplayField ohrmSelectedDisplayField) {
		...
		ohrmSelectedDisplayField.setOhrmDisplayField(null);
