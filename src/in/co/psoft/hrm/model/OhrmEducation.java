...
/**
 * The persistent class for the ohrm_education database table.
 * 
 */
@Entity
@Table(name="ohrm_education")
@NamedQuery(name="OhrmEducation.findAll", query="SELECT o FROM OhrmEducation o")
public class OhrmEducation implements Serializable {
	...
	@OneToMany(mappedBy="ohrmEducation")
	private List<OhrmEmpEducation> ohrmEmpEducations;

	public OhrmEducation() {
	}
	...
	public OhrmEmpEducation addOhrmEmpEducation(OhrmEmpEducation ohrmEmpEducation) {
		...
		ohrmEmpEducation.setOhrmEducation(this);
	...
	public OhrmEmpEducation removeOhrmEmpEducation(OhrmEmpEducation ohrmEmpEducation) {
		...
		ohrmEmpEducation.setOhrmEducation(null);
